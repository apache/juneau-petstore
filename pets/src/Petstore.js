...
class Petstore extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      item0: {},
      format: 'table',
      restUrl: `${window.$backendUrl}/petstore`
    };
  }
        ...
        return (
          <div>
            <Container fluid>
              <Row> 
                <Col>
                  {NavBlock('Petstore application', 'Navigation page')}
                </Col>
              </Row>
              <Row> 
                <Col>
                      ...
                      <div className="outerdata">
                        <div className="data" id="data">
                          ...
                          <Table striped bordered hover>
                            ...
                            <tbody>
                              {petstore.map((petstoreItem) => (
                                <tr key={petstoreItem.key}>
                                  <td>
                                    <a
                                      href={`/petstore/${petstoreItem.name}`}
                                    >
                                      {petstoreItem.name}
